...
# Takes in a digit image address and returns a tuple of (predicted digit, probability)
def predict_digit(image_address):
    processed_image = mnist_preprocess(image_address)
